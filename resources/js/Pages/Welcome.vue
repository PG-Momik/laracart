            ...
            >
              ...
              >
                <img
                    ...
                    class="aspect-video h-full w-full flex-1 rounded-sm object-cover object-top drop-shadow-[0px_4px_34px_rgba(0,0,0,0.06)] dark:hidden"
                    src="https://laravel.com/assets/img/welcome/docs-light.svg"
                    @error="handleImageError"
                />
                <img
                    alt="Laravel documentation screenshot"
                    class="hidden aspect-video h-full w-full flex-1 rounded-sm object-cover object-top drop-shadow-[0px_4px_34px_rgba(0,0,0,0.25)] dark:block"
